...
*The get_csv function of this class has been modified to store pixel values in
a list. This is necessary for functionality of the camera class in Panning.py*
...
class MLX_Cam:
    ...
    def get_csv(self, array, data, limits=None):
